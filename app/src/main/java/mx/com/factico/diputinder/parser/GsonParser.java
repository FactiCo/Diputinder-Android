...
import mx.com.factico.diputinder.models.Candidatos;
...
import mx.com.factico.diputinder.models.Territory;
...
public class GsonParser {
    ...
    public static List<CandidateInfo> getListCandidatesInfoFromJSON(String json) throws Exception {
        ...
        Type listType = new TypeToken<List<CandidateInfo>>() {
        }.getType();
    ...
    public static List<HasTerritory> getListHasTerritoriesFromJSON(String json) throws Exception {
        Gson gson = new Gson();

        Type listType = new TypeToken<List<HasTerritory>>() {
        }.getType();
