 ...
 */
public class TextImagePageFragment extends Fragment {
    public static final String TAG_CLASS = TextImagePageFragment.class.getName();
    ...
    public static Fragment newInstance(int index, Text text) {
        ...
        Fragment fragment = new TextImagePageFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        rootView = (ViewGroup) inflater.inflate(R.layout.fragment_text_image, container, false);
